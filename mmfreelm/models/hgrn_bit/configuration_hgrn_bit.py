...
class HGRNBitConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        moe_enable_sparse_residual: bool = True,
        moe_nominal_shared_width: Optional[int] = None,
        moe_shared_intermediate_size: Optional[int] = None,
        moe_sparse_expert_width: Optional[int] = None,
        moe_sparse_top_k: int = 1,
        moe_shared_init: str = "dense_prefix",
        moe_sparse_init: str = "random_ternary_matched",
        moe_residual_scale_init: float = 0.1,
        moe_residual_scale_learnable: bool = True,
        moe_residual_scale_max: float = 0.5,
        moe_strict_total_param_fair: bool = False,
        moe_auto_resolve_shared_width: bool = False,
        moe_skip_param_budget_resolver: bool = False,
        moe_parameter_budget_verification: Optional[dict] = None,
        ...
        **kwargs
        ...
        self.moe_enable_sparse_residual = moe_enable_sparse_residual
        self.moe_nominal_shared_width = moe_nominal_shared_width
        self.moe_shared_intermediate_size = moe_shared_intermediate_size
        self.moe_sparse_expert_width = moe_sparse_expert_width
        self.moe_sparse_top_k = moe_sparse_top_k
        self.moe_shared_init = moe_shared_init
        self.moe_sparse_init = moe_sparse_init
        self.moe_residual_scale_init = moe_residual_scale_init
        self.moe_residual_scale_learnable = moe_residual_scale_learnable
        self.moe_residual_scale_max = moe_residual_scale_max
        self.moe_strict_total_param_fair = moe_strict_total_param_fair
        self.moe_auto_resolve_shared_width = moe_auto_resolve_shared_width
        self.moe_skip_param_budget_resolver = moe_skip_param_budget_resolver
        self.moe_parameter_budget_verification = moe_parameter_budget_verification
